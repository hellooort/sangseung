...
const fallback: MainBusinessData = {
  ...
  areas: [
    ...
    { title: "SI",            subtitle_ko: "System Integration",            subtitle_en: "System Integration",            description_ko: "시스템 통합",                  description_en: "Integrated system services",           href: "/business/si" },
    { title: "Media Façade",  subtitle_ko: "미디어 파사드",                 subtitle_en: "Media Façade",                  description_ko: "건물 외관 LED 디스플레이",   description_en: "LED displays on building exteriors",   href: "/business/facade" },
    ...
    { title: "IBS",           subtitle_ko: "Intelligent Building System",   subtitle_en: "Intelligent Building System",   description_ko: "A/V, PA, CCTV, CATV 등",      description_en: "A/V, PA, CCTV, CATV and more",         href: "/business/ibs" },
  ],
};

...
const fallback: OfficeRow[] = [
  { id: 1, name_ko: "본사", address_ko: "서울시 강서구 양천로 551-24 한화비즈메트로 2차 903호", phone: "02-953-0056", fax: "02-953-0118", map_embed_url: null, sort_order: 0 },
  { id: 2, name_ko: "미디어시스템사업부", address_ko: "경기도 구리시 갈매순환로166번길 46 금강펜테리움IX타워 제5층 020, 021호", phone: "031-512-0110", fax: "031-512-0120", map_embed_url: null, sort_order: 1 },
  { id: 3, name_ko: "양주공장", address_ko: "경기도 양주시 율정로 20(옥정동) 양주옥정메타엑스 지식산업센터 514, 515호", phone: "031-512-0110", fax: "031-512-0120", map_embed_url: null, sort_order: 2 },
];

export default async function LocationPage() {
  const offices = await getList<OfficeRow>("office_locations", { orderBy: "sort_order" }, fallback);
                    ...
                    {office.map_embed_url ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center text-center">
                        <div>
                          ...
                          <p className="text-[#666] text-sm">{office.address_ko}</p>
                        </div>
                      </div>
                    )}
                  </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                      <div>
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <h2 className="text-white text-xl md:text-2xl font-bold">{office.name_ko}</h2>
                        </div>
                        <p className="text-[#ccc] text-sm md:text-base leading-relaxed">{office.address_ko}</p>
                      </div>
